...
```
git clone git@github.com:nvim-lua/kickstart.nvim.git %userprofile%\AppData\Local\nvim\
```

If you're using `powershell.exe`

```
git clone git@github.com:nvim-lua/kickstart.nvim.git $env:USERPROFILE\AppData\Local\nvim\
```
